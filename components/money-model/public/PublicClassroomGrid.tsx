...
export function PublicClassroomGrid({ offers, basePath }: { offers: Offer[]; basePath: string }) {
  if (offers.length === 0) {
    return (
      <div className="bg-gray-50 border border-dashed border-gray-300 rounded-[25px] p-12 text-center">
        <div className="text-sm font-semibold text-gray-600">No classroom entries yet</div>
        <div className="text-xs text-gray-500 mt-1">
          Check back soon for training videos and notes on each offer.
        </div>
      </div>
    )
  }
